...
This may include a copy of the author's files, and any additional files that the codechecker created to assist them in their CODECHECK.
...
- Literate programming and code chunks (hidden, visible) with nice looking and mostly hassle free PDF output (using [tinytex](https://yihui.name/tinytex/))

...
Our independent runs will act as a _"certificate of reproducible computation"_ to document that core research outputs could be recreated outside of the authors' lab.
